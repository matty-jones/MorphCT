...
def get_terminating_positions(current_atom_posn, bonded_atom_positions, number_of_units_to_add):
    # Given a current_atom_posn and several bonded_atom_positions we can add number_of_units_to_add different terminating units to the current_atom through a series of geometric checks.
